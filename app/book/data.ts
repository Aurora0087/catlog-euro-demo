...
export const accessoryProducts: ProductPage[] = [
  ...
  { page: 0, category: "Leather Accessories", name: "Leather Key Holder", artNo: "EI-AC-4761", leatherType: "aniline leather", color: "Green", finish: "Matte Pull-Up", description: "A compact key holder with swing-out hooks that keep keys silent and scratch-free.", details: ["4-key hooks", "Snap closure", "Brass hardware"], palette: ["#2c1a0a", "#5c3820", "#e8ddd0"], image: images.acc4, imageLabel: "Accessories / 04", imagePosition: "center center" },
  { page: 0, category: "Leather Accessories", name: "Toiletry Pouch", artNo: "EI-AC-5293", leatherType: "aniline leather", color: "Green", finish: "Smooth Polished", description: "A spacious leather toiletry pouch with a waterproof lining — travel-ready and elegantly finished.", details: ["Zip closure", "Waterproof lining", "Interior pockets"], palette: ["#4a5030", "#788050", "#f0f0e8"], image: images.acc5, imageLabel: "Accessories / 05", imagePosition: "center center" },
